    ...
    <section className="flex section-padding py-20 h-[80vh] bg-cyan-950 flex-col">
      <article className=" h-1/3 flex items-start ">
        <div className="flex  items-end w-1/4">
          ...
          <h3 className="text-4xl font-bold text-cyan-50 ml-10 ">WE ARE</h3>
        </div>
        <p className="text-lg text-white w-3/4 px-10">
      ...
      <article className=" h-2/3 flex">
        <div className="flex flex-col px-4 pt-10   items-center h-full w-1/4  gap-10">
          <h2 className="text-white font-semibold text-4xl border-l-8 border-green-400 pl-6">
            Lorem ipsum dolor sit amet.
          </h2>
          <p className="font-thin text-white text-xl px-10 border-l-2 h-full ml-1">
        ...
        <div className="flex flex-col px-4 pt-10   items-center h-full w-1/4  gap-10">
          <h2 className="text-white font-semibold text-4xl border-l-8 border-blue-400 pl-6">
            Lorem ipsum dolor sit amet.
          </h2>
          <p className="font-thin text-white text-xl px-10 border-l-2 h-full ml-1">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla saepe
